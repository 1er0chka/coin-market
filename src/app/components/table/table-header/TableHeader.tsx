...
const TableHeader: FunctionComponent<ITableHeaderParams> = ({objects, setObjects}) => {
    ...
    const changeSort = (newSortType: Sort) => {
        if (newSortType == sortType) {
            ...
            setSortOrder("asc");
            setObjects(objects.toSorted((a, b) => {
    ...
    return (
        ...
        <tr>
            ...
            <th onClick={() => changeSort("priceUsd")}>
                Price {sortType === "priceUsd" ? (sortOrder === "asc" ? "▼" : "▲") : ""}
            </th>
            <th onClick={() => changeSort("changePercent24Hr")}>
                24h% {sortType === "changePercent24Hr" ? (sortOrder === "asc" ? "▼" : "▲") : ""}
            </th>
            <th onClick={() => changeSort("marketCapUsd")}>
                Market Cap {sortType === "marketCapUsd" ? (sortOrder === "asc" ? "▼" : "▲") : ""}
            </th>
            <th></th>
        </tr>
        </thead>
